...
export interface LearnedPrefs {
  version: 1;
  suppressions: Array<{ pattern: string; score: number; lastSeen: string }>;
  amplifications: Array<{ pattern: string; score: number; lastSeen: string }>;
  teamContext: Array<{ note: string; addedAt: string }>;
}
